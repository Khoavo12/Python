...
def main_page():
    ...
    choose = st.sidebar.selectbox('Chọn thông tin', ['Group 3 và dataset','Verified',"Annual Spending","Fake Gegament","Number of Tiktok dowload","TikTokUsersCountryTotal2023"])
    if choose == 'Group 3 và dataset':
        st.header('Group 3')
        st.write('Võ MInh Khoa-10623058')
        st.write('Vũ Thị Hà Vy-10323074')
